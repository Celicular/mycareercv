    ...
    return (
      <div className="flex h-screen bg-brand-offwhite overflow-hidden font-body selection:bg-brand-orange selection:text-white">
        ...
        <main className="flex-1 overflow-y-auto mt-16 md:mt-0 p-6 md:p-10">
          <div className="max-w-6xl mx-auto flex h-[60vh] items-center justify-center text-brand-dark/50">
  ...
  if (error) {
    return (
      <div className="flex h-screen bg-brand-offwhite overflow-hidden font-body selection:bg-brand-orange selection:text-white">
        <Sidebar />
        <main className="flex-1 overflow-y-auto mt-16 md:mt-0 p-6 md:p-10">
          <div className="max-w-6xl mx-auto flex h-[60vh] items-center justify-center">
